...
p_ca_si <- ggplot(df_ca_si, aes(x = DateTime)) +
  night_rect(night_df) +
  # SI = 0 reference line (equilibrium saturation), transformed to primary Ca axis
  geom_hline(
    yintercept = si_to_ca(0), linetype = "dotted",
  ...
  geom_point(
    data   = obs_subsample,
    aes(y = Ca_measured_mgL, colour = "Ca (mg/L)"),
