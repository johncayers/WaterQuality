---
title: "April 2023 EXO Time Series Stephens Lake"
author: "John C. Ayers"
output:
  html_document:
    df_print: paged
---
This notebook analyzes chemical data from in-situ measurements from Stephens Lake in Franklin, TN by John C. Ayers, Ming (Kevin) Chen, and Jialei (Wonder) Wei in April 2023. It creates time series plots illustrating the diel cycles. 
...
print(p)
ggsave("2023_04_SL_TimeSeries.svg")
...
print(p)
ggsave(str_c("2023_04_SL_EXO_TimeSeries_", j, '.png'), plot = p, path = "Plots")
}
```
...
p <- ggplot(PercChangeLong, aes(x = days, y = measurement, color = variable)) +
  theme_bw() +
    ...
    ylab("% change")
print(p)
ggsave("2023_04_SL_TimeSeriesPercChange.svg", path = "Plots")
...
dev.copy(svg, "Plots/202304_SL_CorrelationMatrix.svg")
dev.off()
...
dev.copy(png, "Plots/202304_SL_ScatterplotMatrix.png")
dev.off()
